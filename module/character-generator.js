...
export const createActorWithCharacter = async (characterData) => {
  ...
  return LiminalActor.create(data);
};
...
export const generateCharacter = async () => {
  ...
  const characterGenerator = Liminal.characterGenerator;
